...
//Firebase
import { CreateHomework } from "../Data/db";

const CreateHomeworkModal = ({isOpen, handleClose, LoadLessons}) => {
    ...
    const handleClick = async () => {
        ...
        await CreateHomework(title, description, deadline.valueOf(), fileRef.current.files[0]);
        await LoadLessons();
        handleClosing();
        handleClose();        
    }
    ...
    return (         
        ...
        >
            <Box className="modal">                
                <h1 style={{margin: 0}}>Create <br/> a homework</h1>
                <TextField 
                    id="title" 
                    label="Title" 
                    variant="standard"  
